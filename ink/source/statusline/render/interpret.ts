...
import { getEffect, isMotionEffect, EffectContext } from "./effects/index.js";
...
function pickFrameText(scene: Scene, tick: number): string {
  const frames = scene.frames;
  if (!Array.isArray(frames) || frames.length === 0) return scene.frame;
