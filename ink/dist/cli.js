...
import { getEffectsBySpeed } from "./effects/index.js";
...
if (cli.flags.showcase) {
    render(_jsx(Showcase, {}));
}
else {
    const { waitUntilExit } = render(_jsx(Banner, { effect: cli.flags.effect, theme: cli.flags.theme, speedPreference: cli.flags.speed, holdTime: cli.flags.hold, onComplete: () => {
